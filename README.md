...
> 
> Refer to [WithdrawalCallback()](https://github.com/gimcool/wallet-api-mock-server/blob/main/controllers/OuterController.go#L183) function in mock server OuterController.go
...
<table>
    ...
    The extra information of this callback
	 	<table>
	 	  ...
	 	  <tbody>
		    ...
		    <tr><td>blocklist_tags</td><td>The tags of Gim.Cool AML detection</td></tr>
		    ...
		    <tr><td>aml_tags</td><td>Detailed Gim.Cool AML detection information includes score, tags and blocked flag</td></tr>
		    <tr><td>aml_screen_pass</td><td>Pass or fail Gim.Cool AML screening</td></tr>
	 	  </tbody>
		</table>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
		...
		*pseudo cryptocurrency definition in the Gim.Cool API Wallet system
    </td>
  </tr>
  <tr>
    <td>token_address</td>
